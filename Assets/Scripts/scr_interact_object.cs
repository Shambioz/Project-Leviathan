...
public class scr_interact_object : MonoBehaviour
{
    ...
    public scr_audiomanager scr_audiomanager;
    ...
    void Interact()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (Physics.Raycast(ray, out hit, 10, layerMask))
            {
                ...
                {
                    //get array for audio and text from object's component scr_pickupable
                    scr_audiomanager.audioSources = scr_pickupableInt.audioSources;
                    scr_audiomanager.displayTexts = scr_pickupableInt.displayTexts;
                    //play audio with subtitles
                    scr_audiomanager.PlayAudioAndDisplayText();
                }
